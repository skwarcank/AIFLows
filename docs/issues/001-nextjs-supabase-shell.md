...
Use Supabase Auth rather than custom password storage. Be careful with production redirect URLs; update `docs/setup.md` with exact Supabase Auth URL setup instructions.
...
- [ ] `docs/setup.md` includes exact external Supabase Auth setup instructions.
